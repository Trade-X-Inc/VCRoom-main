...
- **Open, blocking the authorization-port step:**
  ...
  2. The org-code allocation scheme for reference numbering (§20.6) — designed this session (base-36, 6 characters, dedicated singleton counter `pack_v1.next_org_code()`, distinct from `reference_counter`), not yet built, pending review.
