...
This Agreement remains in effect for two (2) years from the date of first execution. All confidentiality obligations survive termination.
...
This Agreement is governed by applicable law. Any disputes shall be subject to the exclusive jurisdiction of courts in the jurisdiction where ${displayCompany} is domiciled${incorporatedIn ? ` (${incorporatedIn})` : ""}.
