...
const REPORT_DISCLAIMER =
  "Generated by AI from public voluntary statements made by the founder during a Lengdon Roast. Not an audit.";
...
function getEnv() {
  ...
  return {
    ...
    openaiKey:
      ...
      "",
    appUrl: cfEnv.VITE_APP_URL || "https://lengdon.com",
  };
}
...
export const createRoastSession = createServerFn({ method: "POST" })
  ...
  .handler(
    async ({
      ...
      // a real Stripe PaymentIntent confirmation once the Lengdon
