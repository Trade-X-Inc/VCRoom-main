      ...
      <aside className="fixed top-0 right-0 bottom-0 z-50 w-full sm:w-[640px] bg-background border-l border-border/60 shadow-elev flex flex-col">
        ...
        <div className="p-5 border-b border-border/60">
          <div className="flex items-start gap-3">
            <div className="grid h-12 w-12 place-items-center rounded-xl bg-gradient-brand text-brand-foreground font-semibold">{lead.initials}</div>
  ...
  return (
    <div className="p-5 space-y-3">
      ...
      {[
        ...
        <div key={i} className="rounded-xl border border-border/60 bg-card p-4 shadow-xs">
...
function FollowUpPanel() {
  ...
  return (
    <div className="p-5 space-y-2">
      ...
      {items.map((it, i) => (
        <div key={i} className="rounded-xl border border-border/60 bg-card p-4 flex items-center gap-3 shadow-xs">
