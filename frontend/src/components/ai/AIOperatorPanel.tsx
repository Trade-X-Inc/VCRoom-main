...
function buildSystemPrompt(pageContext: PageContext, userRole: string): string {
  ...
  return [
    ...
    "- Explain a platform feature ONLY if you can confirm it exists from what you were told — never describe, name, or direct the user to a feature, page, score, or tool you are not certain exists",
    ...
    "- Invent features, scores, tools, or facts. If unsure whether something exists or is true, say you don't have that information rather than making it up. Treat everything you're given as an unverified claim, not established fact.",
    "",
    missingFieldsNote,
    "",
