...
const TERMS = [
  { term: "Acquisition Room", letter: "A", def: "A deal room in Lengdon specifically configured for an M&A or business acquisition. The six-gate sequence is adapted for due diligence completion, regulatory approval, signing, and payment confirmation." },
  ...
  { term: "Close", letter: "C", def: "The final gate of a Lengdon deal room. A close event requires both parties to confirm and seals the complete deal record — nothing in it can be edited or deleted afterward." },
  ...
  { term: "Deal Room", letter: "D", def: "The primary unit of work in Lengdon. A deal room is a sequenced, encrypted workspace that two parties use to formally close a private capital transaction. Each room has its own audit log, gate sequence, NDA enforcement, and permanent record." },
  { term: "Encryption", letter: "E", def: "All documents and communications within a Lengdon deal room are encrypted at rest and in transit. Access requires individual authentication and is scoped to each gate's permissions." },
  ...
  { term: "Gate", letter: "G", def: "One of six sequential checkpoints in a Lengdon deal room. Each gate has specific confirmation requirements that must be met by both parties before the transaction proceeds. Gates are: Counsel, Agreement, Conditions, Signing, Payment, Close." },
  ...
  { term: "Sealed Record", letter: "S", def: "A deal record that becomes permanently closed at the completion of Gate 6. A sealed record cannot be modified, appended, or removed — it stays inspectable in the room, unchanged, for the life of the deal." },
