        ...
        <div className="relative">
          ...
          <div className="mt-32 max-w-md">
            ...
            <p className="mt-4 text-primary-foreground/70">
              {invite.companyName} has invited you to collaborate on their fundraising campaign on Lengdon.
            </p>
          ...
          {accepted ? (
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                You've joined {invite.companyName} on Lengdon.
              </p>
              <button
            ...
            <>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Accept this invitation to collaborate with {invite.companyName} on Lengdon.
              </p>
