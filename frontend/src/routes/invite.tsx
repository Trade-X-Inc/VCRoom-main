  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="rounded-2xl border border-brand/20 bg-gradient-to-r from-brand/5 to-indigo-600/5 p-10 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-4">
            ...
            <Link to="/sign-in" className="text-brand hover:underline font-medium">Sign in</Link>
          </p>
        </div>
      </main>
