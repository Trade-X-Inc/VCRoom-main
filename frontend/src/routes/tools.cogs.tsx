        ...
        <div className="bg-[#0a2540] relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1440px] mx-auto px-12 lg:px-16 py-20 pt-32">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span style={{ fontFamily: "'Inter:Medium', sans-serif" }} className="text-white/50 text-[10px] tracking-[2.5px] uppercase">Tool · COGS</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12">
              ...
              {[
                ...
                <div key={field.label} className="flex flex-col gap-1.5">
                  <div className="flex items-baseline gap-2">
                    ...
                    {field.note && <span style={{ fontFamily: "'Inter:Regular', sans-serif" }} className="text-[#64748b] text-[11px]">{field.note}</span>}
                  </div>
            ...
            <div className="flex flex-col gap-0 border border-[#e6e9ef] divide-y divide-[#e6e9ef] h-fit">
              ...
              <div className="px-6 py-5">
                <div style={{ fontFamily: "'Inter:Regular', sans-serif" }} className="text-[#64748b] text-[12px] leading-[1.6]">
