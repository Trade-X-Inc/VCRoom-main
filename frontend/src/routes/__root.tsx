...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "The fundraising platform where founders and investors meet, run due diligence, negotiate terms, and close deals — entirely in-platform." },
      ...
      { name: "twitter:description", content: "The fundraising platform where founders and investors meet, run due diligence, negotiate terms, and close deals — entirely in-platform." },
