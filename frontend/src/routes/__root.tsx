...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Hockeystick — Where deals get done" },
      ...
      { name: "author", content: "Hockeystick" },
      { name: "theme-color", content: "#6C5CE7" },
      { property: "og:title", content: "Hockeystick — Where deals get done" },
      ...
      { name: "twitter:site", content: "@hockeystickapp" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "/logo-dark.svg" },
      { rel: "apple-touch-icon", href: "/logo-dark.svg" },
    ],
  }),
