...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DFIKBGHT.js");
...
const manifest = {
  ...
  "b0451d818a4af8f61f8d6702b0a87626ab580dea9833910b8d678173c48d62e2": {
    ...
    importer: () => import("./assets/advisor-fn-BozJIJah.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CteB-ixO.js").then((n) => n.r),
