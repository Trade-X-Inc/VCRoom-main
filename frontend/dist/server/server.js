...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-D39ZZkUN.js");
...
const manifest = {
  ...
  "1d719b02e5cbb8bfb1f5fdbf08bea97cdac2cfff952491ca07a2d91de6f74c81": {
    ...
    importer: () => import("./assets/ai-fn-BB0EqMbL.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CAJNflgw.js").then((n) => n.r),
