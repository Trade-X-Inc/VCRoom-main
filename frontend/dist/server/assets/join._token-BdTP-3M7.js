...
import { R as Route, u as useAuth, a as useNavigate, s as supabase } from "./router-DDxKVwv8.js";
import { L as Logo } from "./Logo-CCzGtx2i.js";
import { T as TriangleAlert } from "./triangle-alert-BRF_D58Q.js";
import { C as Check } from "./check-BjFr8Ioo.js";
import { A as ArrowRight } from "./arrow-right-599ZXoEU.js";
import { S as ShieldCheck } from "./shield-check-D6vOCBdi.js";
import { L as Lock } from "./lock-DYx_2dzB.js";
import "node:events";
...
function JoinFlow() {
  ...
  if (loadError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto grid h-14 w-14 place-items-center rounded-full bg-destructive/15 text-destructive", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-7 w-7" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-5 text-xl font-semibold", children: loadError }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Contact the deal room owner for a new invite link." })
    ] }) });
  }
  if (!invite) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground animate-pulse", children: "Loading invite…" }) });
  }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:block relative overflow-hidden bg-primary text-primary-foreground p-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-32 max-w-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-primary-foreground/70", children: [
            companyName,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-6 lg:p-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
      ...
      step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-3", children: [{
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: formData[key], onChange: (e) => setFormData({
            ...formData,
            [key]: e.target.value
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setStep(2), disabled: !formData.fullName.trim(), className: "mt-6 w-full rounded-md bg-gradient-brand text-brand-foreground py-3 text-sm font-medium shadow-glow inline-flex items-center justify-center gap-2 disabled:opacity-50", children: [
          "Continue ",
      ...
      step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 rounded-xl border border-border/60 bg-card p-5 max-h-[280px] overflow-y-auto text-xs leading-relaxed text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: companyName }),
            ' ("Discloser") and',
            " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "mt-4 flex items-start gap-2.5 cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: formData.agreedToNda, onChange: (e) => setFormData({
            ...formData,
        ...
        submitError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xs text-destructive", children: submitError }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !formData.agreedToNda || isSubmitting, onClick: handleSignAndEnter, className: "mt-6 w-full rounded-md bg-gradient-brand text-brand-foreground py-3 text-sm font-medium shadow-glow inline-flex items-center justify-center gap-2 disabled:opacity-50", children: isSubmitting ? "Processing…" : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sign & enter deal room" }),
          " ",
