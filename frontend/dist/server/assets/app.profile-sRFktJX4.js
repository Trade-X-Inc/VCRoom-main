...
import { Loader2, Check, Upload, Globe, Users, Building2, Plus, X, Pencil, Trash2 } from "lucide-react";
import { toast } from "sonner";
import { u as useAuth, s as supabase } from "./router-CYnoakuB.js";
...
function Profile() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("button", { onClick: handleSave, disabled: saving, className: "inline-flex items-center gap-2 rounded-md bg-gradient-brand text-brand-foreground px-4 py-2 text-sm shadow-glow disabled:opacity-60", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-2xl border border-border/60 bg-card shadow-card overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "px-6 pb-6 -mt-10", children: /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pb-1", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground", children: form.description || "Add a tagline below" })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-5 grid lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxs(FormSection, { title: "Company basics", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Field, { label: "Sector", value: form.sector, onChange: field("sector"), placeholder: "B2B SaaS, Fintech…" }),
            /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(TextArea, { label: "Tagline / description", value: form.description, onChange: field("description"), placeholder: "One-line description of your company", rows: 2 })
        ] }),
        ...
        /* @__PURE__ */ jsx(FormSection, { title: "Traction & metrics", children: /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsx(Field, { label: "Revenue / ARR", value: form.revenue, onChange: field("revenue"), placeholder: "$1.2M ARR" }),
          /* @__PURE__ */ jsx(Field, { label: "Traction highlight", value: form.traction, onChange: field("traction"), placeholder: "500 customers, +15% MoM" })
        ] }) }),
        /* @__PURE__ */ jsxs(FormSection, { title: "Pitch content", children: [
          /* @__PURE__ */ jsx(TextArea, { label: "Problem", value: form.problem, onChange: field("problem"), placeholder: "What problem are you solving?", rows: 3 }),
          /* @__PURE__ */ jsx(TextArea, { label: "Solution", value: form.solution, onChange: field("solution"), placeholder: "How does your product solve it?", rows: 3 }),
          /* @__PURE__ */ jsx(TextArea, { label: "Business model", value: form.business_model, onChange: field("business_model"), placeholder: "How do you make money?", rows: 2 })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-3", children: "Overview preview" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: [[Globe, "Stage", form.stage], [Users, "Team", form.team_size], [Building2, "Sector", form.sector]].map(([Icon, label, val]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 text-sm", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs("button", { onClick: handleSave, disabled: saving, className: "w-full inline-flex items-center justify-center gap-2 rounded-md bg-gradient-brand text-brand-foreground px-4 py-2 text-sm shadow-glow disabled:opacity-60", children: [
          saving ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }),
          "Save changes"
        ] }) })
      ] })
    ...
    isLoading ? /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border/60 bg-card p-4 h-24 animate-pulse" }, i)) }) : members.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-dashed border-border/60 bg-card p-8 text-center", children: [
      ...
      return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-4 shadow-card", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 place-items-center rounded-full bg-accent border border-border/60 overflow-hidden text-xs font-semibold shrink-0", children: m.photo_url ? /* @__PURE__ */ jsx("img", { src: m.photo_url, alt: m.full_name, className: "h-full w-full object-cover" }) : initials }),
