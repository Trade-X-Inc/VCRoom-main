...
import { u as useAuth, s as supabase, L as Link, a as useNavigate } from "./router-DliDWiY8.js";
import { u as useQuery } from "./useQuery-DpzAgrXP.js";
import { c as cn } from "./utils-Bz4m9VPB.js";
import { L as LoaderCircle } from "./loader-circle-DLaCHdqJ.js";
import { C as CircleQuestionMark } from "./circle-question-mark-BjFMSAD_.js";
import { B as Building2 } from "./building-2-B3LQT3EX.js";
...
import { A as ArrowUpRight } from "./arrow-up-right-CQYgbfED.js";
...
import { C as Calendar } from "./calendar-Cdx8YqJZ.js";
import "node:events";
...
function HowItWorksModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-foreground/20 backdrop-blur-sm grid place-items-center p-4", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: (e) => e.stopPropagation(), className: "w-full max-w-lg rounded-2xl border border-border/60 bg-card shadow-elev p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "How Venture Room works" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-5", children: steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-8 w-8 shrink-0 place-items-center rounded-full bg-gradient-brand text-brand-foreground text-sm font-semibold", children: s.n }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: s.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground mt-0.5 leading-relaxed", children: s.body })
      ] })
    ] }, s.n)) })
  ] }) });
}
function OnboardingStep({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-xl border border-border/60 bg-card p-6 shadow-card flex flex-col gap-3", disabled && "opacity-50"), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("grid h-10 w-10 place-items-center rounded-lg", disabled ? "bg-muted" : "bg-brand/10"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-5 w-5", disabled ? "text-muted-foreground" : "text-brand") }) }),
      done && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-5 w-5 text-success shrink-0" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1 leading-relaxed", children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { disabled, onClick: () => !disabled && navigate({
      to
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex items-baseline gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-2xl font-semibold tracking-tight", comingSoon && "text-muted-foreground"), children: value }),
      ...
      comingSoon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: "Coming soon", className: "cursor-help inline-flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { className: "h-3.5 w-3.5 text-muted-foreground/60" }) })
    ] }),
...
function Overview() {
  ...
  const [howItWorksOpen, setHowItWorksOpen] = reactExports.useState(false);
  const {
    data: startup = null,
  ...
  if (isNewUser) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold tracking-tight", children: "Welcome to Venture Room 👋" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm text-muted-foreground", children: "Let's get your fundraise set up. Complete these steps to get started." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setHowItWorksOpen(true), className: "rounded-md border border-border/60 px-3 py-2 text-sm hover:bg-accent inline-flex items-center gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-gradient-brand rounded-full transition-all duration-500", style: {
          width: `${progressPct}%`
        } }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingStep, { icon: Building2, title: "Set up your company profile", description: "Add your startup details, team, and pitch so investors know who you are.", buttonLabel: "Set up profile", to: "/app/profile", done: !!startup }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingStep, { icon: Users, title: "Build your investor list", description: "Add VCs manually or import a CSV of investor contacts to target.", buttonLabel: "Add leads", to: "/app/leads", done: leadCount > 0 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingStep, { icon: Briefcase, title: "Create your first deal room", description: "A secure space to share documents and collaborate with investors.", buttonLabel: "Create deal room", to: "/app/deal-rooms", done: dealRoomCount > 0 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingStep, { icon: Mail, title: "Invite your first investor", description: "Send a deal room invite with NDA to a VC you're in conversation with.", buttonLabel: "Go to deal rooms", to: "/app/deal-rooms", done: false, disabled: dealRoomCount === 0 })
      ] }),
      howItWorksOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(HowItWorksModal, { onClose: () => setHowItWorksOpen(false) })
    ] });
  }
  const statusMap = {};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-1 text-2xl font-semibold tracking-tight", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl border border-border/60 bg-card p-6 shadow-card relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-wrap items-end justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-baseline gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-semibold tracking-tight text-muted-foreground", title: "Coming soon", children: "--" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: startup?.target_raise ? `of $${(startup.target_raise / 1e6).toFixed(0)}M target` : "target not set" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-muted-foreground", title: "Coming soon", children: "--" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-5 h-2.5 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 w-0 bg-gradient-brand rounded-full" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-2 flex justify-between text-[11px] text-muted-foreground", children: startup?.target_raise ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Active VCs", value: leadCount, sub: "in pipeline", trend: leadCount > 0 ? `+${leadCount} total` : void 0 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Reply rate", value: "--", sub: "vs benchmark", comingSoon: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Meetings", value: meetingCount, sub: "upcoming" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Deal rooms", value: dealRoomCount, sub: dealRoomCount === 1 ? "1 active" : `${dealRoomCount} active` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 rounded-xl border border-border/60 bg-card shadow-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 grid grid-cols-7 gap-2", children: [["New", statusMap["New"] ?? 0, "bg-muted-foreground/40"], ["Contact", statusMap["Contacted"] ?? 0, "bg-foreground/40"], ["Replied", statusMap["Replied"] ?? 0, "bg-brand"], ["Meeting", statusMap["Meeting Booked"] ?? 0, "bg-violet"], ["Interest", statusMap["Interested"] ?? 0, "bg-warning"], ["DR", statusMap["Deal Room Created"] ?? 0, "bg-success"], ["Pass", statusMap["Rejected"] ?? 0, "bg-destructive/60"]].map(([l, n, c]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border/60 bg-background/40 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground truncate", children: l }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("h-1.5 w-1.5 rounded-full", c) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-lg font-semibold", children: n }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("mt-2 h-1 rounded-full opacity-50", c), style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card shadow-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-b border-border/60 flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Suggested actions" })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card shadow-card", children: [
        ...
        activities.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-8 text-center text-sm text-muted-foreground", children: "No activity yet — invite an investor to get started." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: activities.map((a) => {
          const {
            Icon,
            cls
          } = activityIcon(a.action);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-4 w-4 shrink-0", cls) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 text-sm truncate capitalize", children: a.action.replace(/_/g, " ") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground inline-flex items-center gap-1 shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card shadow-card", children: [
        ...
        dealRooms.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-8 text-center text-sm text-muted-foreground", children: "No deal rooms yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: dealRooms.map((r) => {
          const {
            p,
            bar
          } = dealRoomProgress(r.status);
          const initials = (r.name ?? "?").split(" ").map((s) => s[0] ?? "").join("").slice(0, 2).toUpperCase();
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/app/deal-rooms", className: "flex items-center gap-3 px-5 py-3 hover:bg-accent/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-9 w-9 place-items-center rounded-md bg-gradient-soft text-xs font-semibold border border-border/60", children: initials }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium truncate", children: r.name ?? "Deal Room" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground capitalize", children: r.status ?? "Active" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("h-full", bar), style: {
                width: `${p}%`
              } }) }),
