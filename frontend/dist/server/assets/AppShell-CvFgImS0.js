...
import { u as useAuth, s as supabase, a as useI18n } from "./router-DLzDuQL7.js";
import { formatDistanceToNow } from "date-fns";
import { L as LangSwitcher, T as ThemeToggle } from "./LangSwitcher-C5BnSQOo.js";
...
function AppShell({ children }) {
  ...
  const isInvestor = user?.appRole === "investor" || user?.role === "investor";
  ...
  console.log("[AppShell] role:", user?.role);
