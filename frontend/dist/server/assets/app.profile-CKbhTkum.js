...
import { u as useAuth, s as supabase } from "./router-AGHVmeo2.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-5 grid lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxs(FormSection, { title: "Company basics", children: [
          ...
          /* @__PURE__ */ jsx(TextArea, { label: "Tagline / one-liner", value: form.tagline, onChange: field("tagline"), placeholder: "One sentence describing what you do and for whom", rows: 2 })
        ] }),
        ...
        /* @__PURE__ */ jsx(FormSection, { title: "Traction & metrics", children: /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
          ...
          /* @__PURE__ */ jsx(Field, { label: "Key metric", value: form.key_metric, onChange: field("key_metric"), placeholder: "NPS, CAC, LTV…" }),
        ...
        /* @__PURE__ */ jsxs(FormSection, { title: "Pitch content", children: [
          ...
          /* @__PURE__ */ jsx(TextArea, { label: "Market size", value: form.market_size, onChange: field("market_size"), placeholder: "$50B TAM, $5B SAM…", rows: 2 }),
          /* @__PURE__ */ jsx(TextArea, { label: "Competitive advantage", value: form.competitive_advantage, onChange: field("competitive_advantage"), placeholder: "What makes you hard to replicate?", rows: 2 }),
