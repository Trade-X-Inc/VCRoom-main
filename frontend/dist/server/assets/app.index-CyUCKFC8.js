...
import { Loader2, HelpCircle, Building2, Users, Briefcase, Mail, ArrowUpRight, CheckCircle2, AlertCircle, ExternalLink, Sparkles, Clock, X, TrendingUp, FileText, Calendar } from "lucide-react";
...
function Overview() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-7xl mx-auto", children: [
    ...
    (() => {
      ...
      const actions = [...overdueLeads.map((l) => ({
        key: l.id,
      ...
      if (actions.length === 0) {
        return /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-xl border border-success/30 bg-success/5 px-5 py-3.5 flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-success shrink-0" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-success", children: "You're all caught up" })
        ] });
      }
      return /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx(AlertCircle, { className: "h-3.5 w-3.5 text-warning" }),
          " Today's actions"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-2", children: actions.map((a) => /* @__PURE__ */ jsxs("div", { className: cn("rounded-xl border border-border/60 bg-card px-4 py-3 border-l-4 shadow-card flex items-center justify-between gap-4", a.border), children: [
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium truncate", children: a.label }),
            /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: a.sub })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
            a.link && /* @__PURE__ */ jsxs("a", { href: a.link, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-1.5 rounded-md border border-brand/40 bg-brand/5 text-brand px-3 py-1.5 text-xs hover:bg-brand/10", children: [
              /* @__PURE__ */ jsx(ExternalLink, { className: "h-3 w-3" }),
              " Join"
            ] }),
            a.to && /* @__PURE__ */ jsxs(Link, { to: a.to, className: "inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground", children: [
              "View ",
