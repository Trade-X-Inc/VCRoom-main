import { P as getDefaultExportFromCjs, $ as createServerFn, r as reactExports, U as jsxRuntimeExports } from "./worker-entry-Cmmw-2kk.js";
import { u as useQuery } from "./useQuery-CqUX3-7B.js";
import { u as useAuth, t as toast, c as useQueryClient, s as supabase } from "./router-DUHyCcO4.js";
...
import { F as Flame } from "./flame-BZ4WpVLd.js";
...
function Leads() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 py-5 border-b border-border/60 flex items-center justify-between gap-4 shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: downloadSampleCsv, className: "inline-flex items-center gap-1.5 rounded-md border border-border/60 px-3 py-2 text-sm hover:bg-accent", children: [
