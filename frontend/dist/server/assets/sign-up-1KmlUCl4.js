...
import { s as supabase } from "./router-CteB-ixO.js";
...
function RoleCard({
  ...
  return /* @__PURE__ */ jsxs("button", { type: "button", onClick: isDisabled || locked && active ? void 0 : onClick, disabled: isDisabled, className: cn("relative rounded-xl border p-4 text-left transition-all", isDisabled ? "border-border/30 bg-muted/20 opacity-35 cursor-not-allowed" : active ? "border-brand bg-brand/5 ring-2 ring-brand/20 shadow-glow" : "border-border/60 hover:border-border bg-card cursor-pointer"), children: [
...
function SignUpPage() {
  ...
  if (confirmed) {
    return /* @__PURE__ */ jsx(AuthLayout, { title: "Check your inbox", footer: /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/sign-in", search: {
        redirect: (role ?? "founder") === "investor" ? "/app/investor" : "/app"
  ...
  return /* @__PURE__ */ jsxs(AuthLayout, { title: "Create your workspace", subtitle: "Free for founders. 14-day trial for funds.", footer: /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-2 mb-2", children: [
      /* @__PURE__ */ jsx("div", { className: "text-xs font-medium text-muted-foreground", children: role ? "Signing up as" : "I am a…" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2.5", children: [
        /* @__PURE__ */ jsx(RoleCard, { active: role === "founder", locked: role !== null, onClick: () => setRole("founder"), icon: Rocket, label: "I'm a Founder", sub: "Raising capital for my startup" }),
        /* @__PURE__ */ jsx(RoleCard, { active: role === "investor", locked: role !== null, onClick: () => setRole("investor"), icon: TrendingUp, label: "I'm an Investor", sub: "Reviewing investment opportunities" })
      ] })
    ] }),
    !role && /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center py-1", children: "Select your role above to continue" }),
    role && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(GoogleButton, { onClick: google }),
      /* @__PURE__ */ jsx(Divider, {})
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: cn("space-y-3.5", !role && "hidden"), children: [
      ...
      /* @__PURE__ */ jsx("button", { type: "submit", disabled: loading || !role, title: !role ? "Please select your role to continue" : void 0, className: "w-full inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-brand text-brand-foreground py-2.5 text-sm font-medium shadow-glow disabled:opacity-60", children: loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
