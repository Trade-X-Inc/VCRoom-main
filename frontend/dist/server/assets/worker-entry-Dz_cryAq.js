...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CUDq7m30.js");
...
const manifest = {
  "56f68b50d6d653ae4f4287eb005bbb35fecea7fa7ce69a4b2a6cc974383a502e": {
    ...
    importer: () => import("./deal-brief-fn-BroFxo9O.js")
  },
  "1d719b02e5cbb8bfb1f5fdbf08bea97cdac2cfff952491ca07a2d91de6f74c81": {
    ...
    importer: () => import("./ai-fn-lkkGvwxW.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DDxKVwv8.js").then((n2) => n2.C),
