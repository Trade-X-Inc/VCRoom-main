...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D_rOafxn.js");
...
const manifest = {
  ...
  "1d719b02e5cbb8bfb1f5fdbf08bea97cdac2cfff952491ca07a2d91de6f74c81": {
    ...
    importer: () => import("./ai-fn-iiPzD7qm.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DliDWiY8.js").then((n2) => n2.C),
