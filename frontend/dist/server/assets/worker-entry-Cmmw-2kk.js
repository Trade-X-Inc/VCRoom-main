...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CS2lAcLk.js");
...
const manifest = {
  ...
  "1d719b02e5cbb8bfb1f5fdbf08bea97cdac2cfff952491ca07a2d91de6f74c81": {
    ...
    importer: () => import("./ai-fn-KUoqgh54.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DUHyCcO4.js").then((n2) => n2.C),
