...
function SignInPage() {
  ...
  return /* @__PURE__ */ jsxs(AuthLayout, { title: "Welcome back", subtitle: "Sign in to your Venture Room workspace.", footer: /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 p-3 bg-muted rounded-lg text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsx("p", { className: "font-medium mb-2", children: "Test navigation:" }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsx("a", { href: "/app", className: "text-brand underline", children: "Founder dashboard" }),
        /* @__PURE__ */ jsx("a", { href: "/app/investor/", className: "text-brand underline", children: "Investor dashboard" })
      ] })
    ] })
  ] });
}
