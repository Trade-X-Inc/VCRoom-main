...
import { User, Sparkles, Loader2, Send, Users, Paperclip, Smile, Plus, Filter, AlertTriangle, Circle, Clock, CheckCircle2, Upload, FileText, XCircle, X, ChevronDown, ChevronRight, Download, FileQuestion, FileCheck, LogOut, Search, ArrowLeft, ArrowRight, ZoomOut, ZoomIn, Printer, Star, LayoutGrid, MessageSquare, ListChecks, MessagesSquare, StickyNote, Activity, Calendar, Gavel, Lock, UserPlus, HelpCircle, ThumbsUp, ExternalLink, Shield } from "lucide-react";
import { useQueryClient, useQuery } from "@tanstack/react-query";
import { p as postJson } from "./backend-CMfy16B4.js";
import { a as useI18n, u as useAuth, c as uploadDocument, s as supabase, l as logActivity, d as createNotification, e as Route } from "./router-C9QH749P.js";
import { c as cn } from "./utils-H80jjgLf.js";
import { q as qaStore, p as participantsStore, a as useGeneratedNdaDocs } from "./store-_LLbTvev.js";
...
function DealRoom() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-[calc(100vh-4rem)] relative", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 overflow-y-auto", children: [
      tab === "overview" && /* @__PURE__ */ jsx(DealRoomOverview, { dealRoomId, room, memberList, isInvestor, isFounder, onTabChange: setTab }),
      tab === "documents" && /* @__PURE__ */ jsx(Documents, { dealRoomId, isFounder, userId: user?.id }),
...
function DealRoomOverview({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-8 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-6 mb-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider text-muted-foreground font-semibold", children: isInvestor ? "Reviewing" : "Deal Room" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-1 text-2xl font-semibold tracking-tight", children: startup?.company_name ?? "Deal Room" }),
        startup?.tagline && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: startup.tagline })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex gap-2 shrink-0", children: isFounder ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("documents"), className: "inline-flex items-center gap-1.5 rounded-md border border-border/60 px-3 py-2 text-sm hover:bg-accent", children: [
          /* @__PURE__ */ jsx(UserPlus, { className: "h-4 w-4" }),
          " Invite"
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("chat"), className: "inline-flex items-center gap-1.5 rounded-md bg-gradient-brand text-brand-foreground px-3 py-2 text-sm shadow-glow", children: [
          /* @__PURE__ */ jsx(Send, { className: "h-4 w-4" }),
          " Send update"
        ] })
      ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("qa"), className: "inline-flex items-center gap-1.5 rounded-md border border-warning/40 bg-warning/10 text-warning px-3 py-2 text-sm hover:bg-warning/15", children: [
          /* @__PURE__ */ jsx(HelpCircle, { className: "h-4 w-4" }),
          " Request info"
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("decision"), className: "inline-flex items-center gap-1.5 rounded-md border border-success/40 bg-success/10 text-success px-3 py-2 text-sm hover:bg-success/15", children: [
          /* @__PURE__ */ jsx(ThumbsUp, { className: "h-4 w-4" }),
          " Submit review"
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-5 gap-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "md:col-span-3 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-gradient-brand text-brand-foreground font-bold text-sm", children: startup?.company_name?.[0] ?? "D" }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: startup?.company_name ?? "Company" }),
              startup?.tagline && /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: startup.tagline }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5 mt-2", children: [
                startup?.stage && /* @__PURE__ */ jsx("span", { className: "text-[11px] px-2 py-0.5 rounded-full bg-brand/10 text-brand", children: startup.stage }),
                startup?.sector && /* @__PURE__ */ jsx("span", { className: "text-[11px] px-2 py-0.5 rounded-full bg-accent text-muted-foreground", children: startup.sector })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-3", children: [
            startup?.funding_target && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-accent/50 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Raising" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mt-0.5", children: startup.funding_target })
            ] }),
            startup?.revenue && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-accent/50 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "ARR" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mt-0.5", children: startup.revenue })
            ] }),
            startup?.team_size && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-accent/50 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Team size" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mt-0.5", children: startup.team_size })
            ] }),
            startup?.website && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-accent/50 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Website" }),
              /* @__PURE__ */ jsxs("a", { href: startup.website, target: "_blank", rel: "noopener noreferrer", className: "text-sm font-semibold text-brand mt-0.5 flex items-center gap-1 hover:underline", children: [
                /* @__PURE__ */ jsx(ExternalLink, { className: "h-3 w-3" }),
                " Visit"
              ] })
            ] })
          ] }),
          (startup?.problem || startup?.solution) && /* @__PURE__ */ jsxs("div", { className: "mt-3 border-t border-border/60 pt-3", children: [
            /* @__PURE__ */ jsxs("button", { onClick: () => setShowProblem((v) => !v), className: "text-xs text-brand hover:underline", children: [
              showProblem ? "Hide" : "Show",
              " problem / solution"
            ] }),
            showProblem && /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-3", children: [
              startup.problem && /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-semibold", children: "Problem" }),
                /* @__PURE__ */ jsx("div", { className: "text-sm mt-1", children: startup.problem })
              ] }),
              startup.solution && /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-semibold", children: "Solution" }),
                /* @__PURE__ */ jsx("div", { className: "text-sm mt-1", children: startup.solution })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            ...
            isFounder && /* @__PURE__ */ jsxs("button", { className: "text-xs inline-flex items-center gap-1 text-muted-foreground hover:text-foreground", children: [
              /* @__PURE__ */ jsx(UserPlus, { className: "h-3.5 w-3.5" }),
              " Invite"
            ] })
          ] }),
          memberList.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "No participants yet." }) : /* @__PURE__ */ jsx("div", { className: "divide-y divide-border/60", children: memberList.map((m) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 py-2.5", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-8 w-8 place-items-center rounded-full bg-accent text-[11px] font-semibold shrink-0", children: (m.users?.full_name ?? "?").split(" ").map((s) => s[0]).slice(0, 2).join("") }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-medium truncate", children: m.users?.full_name ?? "Unknown" }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground truncate", children: m.users?.email ?? "" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end gap-1 shrink-0", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] capitalize text-muted-foreground", children: m.role }),
              /* @__PURE__ */ jsx("span", { className: cn("text-[10px] px-2 py-0.5 rounded", memberStatusColor(!!m.accepted_at)), children: m.accepted_at ? "NDA Accepted" : "Invited" })
            ] })
          ] }, m.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-3", children: "Deal status" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Stage" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium capitalize", children: room?.status ?? "Active" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Days open" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: daysOpen })
            ] }),
            lastActivity && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Last activity" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: formatDistanceToNow(new Date(lastActivity), {
                addSuffix: true
              }) })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 border-t border-border/60 pt-4", children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground font-semibold uppercase tracking-wider mb-2", children: "Quick actions" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: isFounder ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("documents"), className: "w-full text-left text-sm px-3 py-2 rounded-md border border-border/60 hover:bg-accent flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(FileText, { className: "h-3.5 w-3.5 text-brand" }),
                " Upload document"
              ] }),
              /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("meetings"), className: "w-full text-left text-sm px-3 py-2 rounded-md border border-border/60 hover:bg-accent flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Calendar, { className: "h-3.5 w-3.5 text-brand" }),
                " Schedule meeting"
              ] }),
              /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("chat"), className: "w-full text-left text-sm px-3 py-2 rounded-md border border-border/60 hover:bg-accent flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5 text-brand" }),
              ...
              /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("qa"), className: "w-full text-left text-sm px-3 py-2 rounded-md border border-border/60 hover:bg-accent flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(MessageSquare, { className: "h-3.5 w-3.5 text-brand" }),
                " Ask a question"
              ] }),
              /* @__PURE__ */ jsxs("button", { onClick: () => onTabChange("decision"), className: "w-full text-left text-sm px-3 py-2 rounded-md border border-border/60 hover:bg-accent flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(ThumbsUp, { className: "h-3.5 w-3.5 text-success" }),
                " Submit review"
              ] })
            ] }) })
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-3", children: "Recent activity" }),
          recentActivity.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "No activity yet." }) : /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: recentActivity.map((e) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-brand mt-1.5 shrink-0" }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm truncate", children: e.action }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: formatDistanceToNow(new Date(e.created_at), {
                addSuffix: true
              }) })
            ] })
          ] }, e.id)) })
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-8 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        isFounder && /* @__PURE__ */ jsxs("button", { onClick: () => setShowLibrary(true), className: "inline-flex items-center gap-1.5 rounded-md border border-brand/40 bg-brand/5 text-brand px-3 py-1.5 text-sm hover:bg-brand/10", children: [
          /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }),
          " Add from library"
        ] }),
    ...
    isFounder && /* @__PURE__ */ jsx("div", { className: "mt-5", children: /* @__PURE__ */ jsx(Dropzone, { dealRoomId, onUploadComplete: () => queryClient.invalidateQueries({
      queryKey: ["documents", dealRoomId]
    }) }) }),
    showLibrary && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 bg-foreground/20 backdrop-blur-sm grid place-items-center p-4", onClick: () => setShowLibrary(false), children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg rounded-2xl border border-border/60 bg-card shadow-elev", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-5 border-b border-border/60", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: "Add from document library" }),
        /* @__PURE__ */ jsx("button", { onClick: () => setShowLibrary(false), className: "grid h-8 w-8 place-items-center rounded-md text-muted-foreground hover:bg-accent", children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4" }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-3 max-h-80 overflow-y-auto", children: [
        libLoading && /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground p-3 animate-pulse", children: "Loading…" }),
        !libLoading && libraryDocs.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground p-3", children: "No personal documents without a deal room. Upload documents in the Documents page first." }),
        libraryDocs.map((doc) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-3 rounded-lg hover:bg-accent/50", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-8 w-8 place-items-center rounded-md bg-accent shrink-0", children: /* @__PURE__ */ jsx(FileText, { className: "h-4 w-4 text-brand" }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium truncate", children: doc.name || doc.storage_path?.split("/").pop() || "Document" }),
            doc.category && /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: doc.category })
          ] }),
          /* @__PURE__ */ jsxs("button", { onClick: () => addFromLibrary(doc.id), disabled: addingFromLib === doc.id, className: "shrink-0 inline-flex items-center gap-1 rounded-md bg-gradient-brand text-brand-foreground px-3 py-1.5 text-xs disabled:opacity-50", children: [
            addingFromLib === doc.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-3 w-3 animate-spin" }) : /* @__PURE__ */ jsx(Plus, { className: "h-3 w-3" }),
            "Add"
          ] })
        ] }, doc.id))
      ] })
    ...
    docs.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-5 rounded-xl border border-border/60 bg-card shadow-card divide-y divide-border/60", children: docs.map((doc) => {
      const catColor = CATEGORY_COLORS[doc.category] ?? "bg-accent text-muted-foreground";
      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-5 py-3 hover:bg-accent/40 group", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-0.5 flex-wrap", children: [
            doc.category && /* @__PURE__ */ jsx("span", { className: cn("text-[10px] px-1.5 py-0.5 rounded-full", catColor), children: doc.category }),
        ...
        isFounder && /* @__PURE__ */ jsx("button", { onClick: () => removeFromRoom(doc.id), title: "Remove from deal room", className: "text-muted-foreground hover:text-destructive opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4" }) })
      ] }, doc.id);
    }) }),
    docs.length === 0 && /* @__PURE__ */ jsxs("div", { className: "mt-8 rounded-xl border border-border/60 bg-card shadow-card p-10 flex flex-col items-center gap-3 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 place-items-center rounded-full bg-accent", children: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5 text-muted-foreground" }) }),
      /* @__PURE__ */ jsx("div", { className: "text-sm font-medium", children: "No documents yet" }),
      /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground max-w-xs", children: isFounder ? "Upload files above or add from your document library." : "The founder hasn't shared any documents yet." })
    ] })
  ] });
}
function Notes({
