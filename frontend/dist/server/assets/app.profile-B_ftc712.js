...
import { Download, Edit3, Eye, Loader2, Upload, Zap, AlignLeft, Plus, X, Check, Users, Pencil, Trash2, Globe, Building2 } from "lucide-react";
...
function Profile() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const {
        data: existing
      } = await supabase.from("startups").select("id").eq("founder_id", user.id).maybeSingle();
      let error;
      if (existing?.id) {
        const {
          error: updateError
  ...
  if (mode === "view") {
    ...
    const pairs = [["Stage", form.stage], ["Sector", form.sector], ["Country", form.country], ["Website", form.website], ["Founded", form.founded_year], ["Team size", form.team_size], ["Revenue / ARR", form.revenue], ["Growth rate", form.growth_rate], ["Customers", form.customer_count], ["Key metric", form.key_metric], ["Funding target", form.funding_target], ["Valuation", form.valuation], ["Previous funding", form.previous_funding], ["Current investors", form.current_investors], ["Market size", form.market_size]].filter(([, v]) => filled(v));
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3 mb-6 no-print", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold tracking-tight", children: "Company Profile" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "How investors see your startup." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("button", { onClick: handleDownloadPDF, className: "inline-flex items-center gap-1.5 rounded-md border border-border/60 px-3 py-2 text-sm hover:bg-accent", children: [
              /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }),
              " Download PDF"
            ] }),
            /* @__PURE__ */ jsxs("button", { onClick: () => setMode("edit"), className: "inline-flex items-center gap-1.5 rounded-md bg-gradient-brand text-brand-foreground px-3 py-2 text-sm shadow-glow", children: [
              /* @__PURE__ */ jsx(Edit3, { className: "h-4 w-4" }),
              " Edit profile"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-border/60 bg-card shadow-card overflow-hidden print-card", children: [
          /* @__PURE__ */ jsx("div", { className: "h-28 bg-gradient-mesh relative", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 noise opacity-40" }) }),
          /* @__PURE__ */ jsx("div", { className: "px-6 pb-6 -mt-10", children: /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-20 w-20 place-items-center rounded-2xl bg-gradient-brand text-brand-foreground text-2xl font-semibold border-4 border-background shadow-elev overflow-hidden shrink-0", children: logoUrl ? /* @__PURE__ */ jsx("img", { src: logoUrl, alt: "logo", className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsx("span", { children: initials }) }),
            /* @__PURE__ */ jsxs("div", { className: "pb-1", children: [
              /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold", children: form.company_name || "Unnamed Company" }),
              filled(form.tagline) && /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: form.tagline }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-2 flex-wrap", children: [
                filled(form.stage) && /* @__PURE__ */ jsx("span", { className: "rounded-full bg-brand/10 text-brand text-xs px-2.5 py-0.5 font-medium", children: form.stage }),
                filled(form.sector) && /* @__PURE__ */ jsx("span", { className: "rounded-full bg-violet/10 text-violet text-xs px-2.5 py-0.5 font-medium", children: form.sector })
              ] })
            ] })
          ] }) })
        ] }),
        filled(form.description) && /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-2", children: "About" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: form.description })
        ] }),
        pairs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-3", children: "Key details" }),
          /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-x-8 gap-y-2.5", children: pairs.map(([label, val]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-border/40 pb-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: label }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: val })
          ] }, label)) })
        ] }),
        (filled(form.problem) || filled(form.solution)) && /* @__PURE__ */ jsxs("div", { className: "mt-4 grid sm:grid-cols-2 gap-4", children: [
          filled(form.problem) && /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-2", children: "Problem" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: form.problem })
          ] }),
          filled(form.solution) && /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-2", children: "Solution" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: form.solution })
          ] })
        ] }),
        (filled(form.traction) || filled(form.business_model) || filled(form.use_of_funds) || filled(form.why_now) || filled(form.competitive_advantage)) && /* @__PURE__ */ jsx("div", { className: "mt-4 space-y-4", children: [["Traction highlights", form.traction], ["Business model", form.business_model], ["Use of funds", form.use_of_funds], ["Why now?", form.why_now], ["Competitive advantage", form.competitive_advantage]].filter(([, v]) => filled(v)).map(([label, val]) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-2", children: label }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: val })
        ] }, label)) }),
        (filled(form.founder_name) || filled(form.founder_email)) && /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-xl border border-border/60 bg-card p-5 shadow-card print-card", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold mb-3", children: "Contact" }),
          /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: [["Founder", form.founder_name], ["Email", form.founder_email], ["LinkedIn", form.founder_linkedin], ["Co-founder", form.cofounder_name], ["Co-founder LinkedIn", form.cofounder_linkedin]].filter(([, v]) => filled(v)).map(([label, val]) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: label }),
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium mt-0.5", children: val })
          ] }, label)) })
        ] }),
        startup?.id && /* @__PURE__ */ jsx("div", { className: "mt-4 no-print", children: /* @__PURE__ */ jsx(TeamMembersSection, { startupId: startup.id, readOnly: true }) })
      ] })
    ] });
  }
  const SaveBtn = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold tracking-tight", children: startup ? "Edit profile" : "Create your profile" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        startup && /* @__PURE__ */ jsxs("button", { onClick: () => setMode("view"), className: "inline-flex items-center gap-1.5 rounded-md border border-border/60 px-3 py-2 text-sm hover:bg-accent", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-5 flex items-center gap-1 rounded-lg border border-border/60 bg-muted/30 p-1 w-fit", children: [
      /* @__PURE__ */ jsxs("button", { onClick: () => setTab("quick"), className: cn("inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm transition-colors", tab === "quick" ? "bg-background text-foreground font-medium shadow-xs" : "text-muted-foreground hover:text-foreground"), children: [
        /* @__PURE__ */ jsx(Zap, { className: "h-3.5 w-3.5" }),
        " Quick setup"
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => setTab("full"), className: cn("inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm transition-colors", tab === "full" ? "bg-background text-foreground font-medium shadow-xs" : "text-muted-foreground hover:text-foreground"), children: [
        /* @__PURE__ */ jsx(AlignLeft, { className: "h-3.5 w-3.5" }),
        " Full details"
      ] })
    ] }),
    tab === "quick" ? (
      // QUICK SETUP: 5 fields
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs(FormSection, { title: "Quick setup", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsx(SaveBtn, { full: true }) })
        ] }) }),
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(RightCol, { form, deckName, deckUploading, onDeckUpload: handleDeckUpload }) })
      ] })
    ) : (
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
          /* @__PURE__ */ jsxs(FormSection, { title: "Company basics", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsx(Field, { label: "Website", value: form.website, onChange: field("website"), placeholder: "https://example.com" }),
              /* @__PURE__ */ jsx(Field, { label: "Founded year", value: form.founded_year, onChange: field("founded_year"), placeholder: "2022" }),
              /* @__PURE__ */ jsx(Field, { label: "Country / HQ", value: form.country, onChange: field("country"), placeholder: "San Francisco, USA" }),
              /* @__PURE__ */ jsx(Field, { label: "Team size", value: form.team_size, onChange: field("team_size"), placeholder: "12" }),
              /* @__PURE__ */ jsx(Field, { label: "Sector", value: form.sector, onChange: field("sector"), placeholder: "B2B SaaS, Fintech, AI..." }),
              /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(TextArea, { label: "Description", value: form.description, onChange: field("description"), placeholder: "What does your company do?", rows: 3 })
          ] }),
          ...
          /* @__PURE__ */ jsx(FormSection, { title: "Contact", children: /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Field, { label: "Founder email", value: form.founder_email, onChange: field("founder_email"), placeholder: "jane@startup.com" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsx(RightCol, { form, deckName, deckUploading, onDeckUpload: handleDeckUpload }) })
      ] })
    ),
    startup?.id && /* @__PURE__ */ jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsx(TeamMembersSection, { startupId: startup.id }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 shadow-card", children: [
      ...
      deckName ? /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/60 bg-accent/30 p-3", children: [
        ...
        /* @__PURE__ */ jsxs("label", { className: "text-xs text-brand hover:underline cursor-pointer", children: [
          "Replace",
          /* @__PURE__ */ jsx("input", { type: "file", accept: ".pdf,.pptx,.key", className: "sr-only", onChange: (e) => e.target.files?.[0] && onDeckUpload(e.target.files[0]) })
        ] })
...
function TeamMembersSection({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      ...
      !readOnly && /* @__PURE__ */ jsxs("button", { onClick: () => {
        closeForm();
        setShowForm((v) => !v);
    ...
    !readOnly && showForm && /* @__PURE__ */ jsxs("div", { className: "mb-5 rounded-xl border border-brand/30 bg-card p-5 shadow-card", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("input", { value: mf.email, onChange: setField("email"), placeholder: "jane@company.com", className: "mt-1 w-full rounded-md border border-border/60 bg-background px-3 py-2 text-sm focus:outline-none focus:border-brand/50" })
          ] }),
    ...
    isLoading ? /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border/60 bg-card p-4 h-24 animate-pulse" }, i)) }) : members.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-dashed border-border/60 bg-card p-8 text-center", children: [
      ...
      return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-4 shadow-card", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          !readOnly && /* @__PURE__ */ jsxs("div", { className: "flex gap-1 shrink-0", children: [
